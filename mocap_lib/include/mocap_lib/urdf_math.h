...
geometry_msgs::Vector3 urdf_to_geometry_msg( const urdf::Vector3& v )
{
...
urdf::Vector3 geometry_msgs_translation_to_urdf( const geometry_msgs::Vector3& v )
{
  return urdf::Vector3( v.x, v.y, v.z );
}

geometry_msgs::Quaternion urdf_to_geometry_msg( const urdf::Rotation& r )
{
...
urdf::Rotation geometry_msgs_quaternion_to_urdf( const geometry_msgs::Quaternion q )
{
  urdf::Rotation r;
  r.w = q.w;
  r.x = q.x;
